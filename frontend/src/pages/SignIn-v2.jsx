...
import { Eye, EyeOff, Lock, Mail, Zap, AlertCircle, Loader2, CheckCircle } from 'lucide-react'
...
function SignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white dark:bg-[#1f1f1f] p-8">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center gap-3">
            ...
            <img src="assets/images/drop2chat.png" alt="drop2chat logo" className="h-24 w-24 text-white" />
          </div>
        </div>
